...
def main():
    ...
    resolver = gen3validator.ResolveSchema(schema_path=schema_path)
    ...
    data_fail = gen3validator.ParseData(data_folder_path=fail_data_folder)
    ...
    data_pass = gen3validator.ParseData(data_folder_path=pass_data_folder)
